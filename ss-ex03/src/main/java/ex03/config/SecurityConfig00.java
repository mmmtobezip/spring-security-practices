...
public class SecurityConfig00 {
  ...
  public UsernamePasswordAuthenticationFilter usernamePasswordProcessingFilter() {
    UsernamePasswordAuthenticationFilter usernamePasswordProcessingFilter =
    ...
    return new DefaultFilterInvocationSecurityMetadataSource(new LinkedHashMap<>() {
      {
        ...
        put(new RegexRequestMatcher("^/board/?(write|reply|delete)$", null),
  ...
  public AccessDecisionManager accessDecisionManager() {
    return new AffirmativeBased(
        Arrays.asList(authenticatedVoter(), roleVoter(), webExpressionVoter()
