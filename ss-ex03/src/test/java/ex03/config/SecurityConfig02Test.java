...
@ContextConfiguration(locations = {"classpath:ex03/config/WebConfig.xml",
    "classpath:ex03/config/SecurityConfig01.xml"})
@WebAppConfiguration
public class SecurityConfig02Test {
  ...
  public void setup(WebApplicationContext context) {
    filterChainProxy =
        (FilterChainProxy) context.getBean("springSecurityFilterChain", Filter.class);
